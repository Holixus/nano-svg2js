...
/*function massive(name, fn, pairs, sradix, dradix) {
	suite(name, function () {
		for (var i = 0, n = pairs.length; i < n; i += 2)
			(function (args, ret) {
				test(fn.name+'('+jso.js2str(args, sradix)+') -> '+jso.js2str(ret, dradix)+'', function (done) {
...
',
	...
	'defs', [
		...
		'linearGradients', [ 'gradientUnits', 'userSpaceOnUse',
			...
			'4', [ 'line', '10 4 6 18',
				'stops', [ '0', '#0062ff', '.446', '#87b4ff', '1', '#fff' ] ],
			'5', [ 'line', '11 18 11 -3',
	...
	'symbols', [ 'viewBox', '0 0 16 16',
		...
		'ic-volume', [
			...
			'path', [ 'stroke-linejoin', 'round', 'd', 'M4.184 10.976c-.29.175-.382.55-.208.84.175.29.55.382.84.208.026-.016.045-.036.058-.045l3.474-2.81-4.092 1.777c-.015.006-.044.013-.072.03z', 'stroke', 'url(#5)', 'stroke-width', '.4', 'fill', 'url(#5)' ],
			'path', [ 'opacity', '.5', 'd', 'M9 14.5l.5-.5H12l.5.5-.5.5H9.5l-.5-.5z', 'fill', 'url(#5)' ] ] ] ],
    js_storage_p = [ '[voc]', 'd\tpath\tfill\tstroke-width\tstroke\t1\t0\turl(#5)\tstops\tstroke-linejoin\tround\tline\t#fff\t#001138\t.5\tg\t.4\topacity\t7\turl(#7)\turl(#2)\tviewBox\t0.4\t8\t#0062ff\t0 0 16 16\tcircle\tcx\tcy\tr', 21, 25,
	'defs', [
		'filters', [
		...
		'linearGradients', [ 'gradientUnits', 'userSpaceOnUse',
			...
			'3', [ 11, '4.268 5.732 4.509 7.652',
				8, [ 6, 12, '.584', '#dcdcdc', 5, '#a9a9a9' ] ],
			'4', [ 11, '10 4 6 18',
				8, [ 6, 24, '.446', '#87b4ff', 5, 12 ] ],
			'5', [ 11, '11 18 11 -3',
				8, [ 6, 13, 5, '#edf3ff' ] ],
			'6', [ 11, '14.5 12.5 -.5 4',
				8, [ 6, 13, 5, '#e9f0ff' ] ],
	...
	'symbols', [ 21, 25,
		'ic-up', [
			1, [ 9, 10, 0, 'm7.5 2-5 5.5 3.5-1v7h6.5l1.5-2.5h-5v-4.5l3.5 1z', 4, 13, 3, 22, 2, 20 ] ],
		'ic-folder', [
			15, [ 9, 10, 4, 13, 3, 16,
		...
		'ic-file', [
			15, [ 9, 10, 3, 22,
				...
				1, [ 0, 'm10.5 0.5v3h3l-3-3z', 4, 7, 2, 12 ],
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 15 15">\n\
	...
	massive('optimizeIds', function (o) {
		var js = jsvg.optimizeIds(clone(o));
